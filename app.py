...
st.markdown("""
    <style>
        ...
        /* Add this to the <style> section in app.py */

        /* Global text color fix */
        body, p, h1, h2, h3, h4, h5, h6, .stMarkdown, .stButton, .stSelectbox {
        ...
        /* Fix card styling for model display */
        .card {
            background-color: #f8f9fa;
            border-radius: 8px;
            padding: 15px;
        ...
        /* Status indicators with fixed contrast */
        .status-ok {
        ...
        /* Improve checkboxes and radio buttons contrast */
        ...
        [data-testid="stSidebarNav"] p, [data-testid="stSidebarNav"] h1, [data-testid="stSidebarNav"] h2 {
            color: #333333 !important;
        }
